...
from .utils import submit_code, get_submission_result, SUPPORTED_LANGUAGE_MAP
...
class CodingAIEvalXBlock(AIEvalXBlock):
    ...
    judge0_api_key = String(
        ...
        help=_("Enter your the Judge0 API key used to execute code on Judge0."),
        default="",
        scope=Scope.settings,
    )
    ...
    language = String(
        ...
        default=next(iter(SUPPORTED_LANGUAGE_MAP)),
        Scope=Scope.settings,
    )
    messages = Dict(
    ...
    def student_view(self, context=None):
        ...
        """
        # html = self.resource_string("static/html/coding_ai_eval.html")
        ...
        frag = Fragment(html)  # (html.format(self=self))
