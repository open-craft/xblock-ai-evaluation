...
var initializer = makeXBlockInitializer(
  function CodingStudioPlaceholder(props) {
    return React.createElement(StudioPlaceholder, {
      title: "Coding Studio Shell",
      blockKind: "coding",
...
window.AIEvalReactXBlocks.codingStudio = initializer;
window.CodingAIEvalXBlockStudio = initializer;
